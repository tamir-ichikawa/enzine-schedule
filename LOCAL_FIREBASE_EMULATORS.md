...
- 事業所別ロゴの例: `http://127.0.0.1:5000/?firebaseEmulators=1&office=demo-office-a`
...
事業所別ロゴを使う場合は、[office-logos/README.md](office-logos/README.md) に従って `office-logos/{officeId}.png` を置きます。画像がない場合はロゴを表示しません。URLの `office` は見た目の選択だけで、ログイン後の所属・権限には使用しません。
